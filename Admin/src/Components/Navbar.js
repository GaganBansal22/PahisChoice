    ...
    return (
        <>
            ...
            <div className="">
                ...
                {/* Side Panel */}
                <div className={`fixed z-20  ${ispanel && 'hidden'} md:block  top-0 left-0 w-[100%] h-[100vh] md:w-1/5 bg-black bg-opacity-80`}>
                    <IoIosCloseCircleOutline onClick={panel} className="text-slate-200 absolute right-3 top-4  text-5xl md:hidden" />
                    <div className="w-[80%] md:w-[100%] bg-slate-900 px-5 h-[100vh] ">
                        ...
                        <div className="text-white mt-12 space-y-2">
                            <Link href={"/"}>
                                <div onClick={() => handleChange('Dashboard')} className={`flex items-center ${categories.Dashboard && 'bg-slate-800'} hover:bg-slate-800 cursor-pointer py-3 rounded-md px-2 mb-2 space-x-2`}>
                                    <HiOutlineHome className="text-2xl" />
                                    <span>Dashboard</span>
                                </div>
                            </Link>
                            <Link href='/orders'>
                                <div onClick={() => handleChange('Orders')} className={`flex items-center ${categories.Orders && 'bg-slate-800'} hover:bg-slate-800 cursor-pointer py-3 rounded-md px-2 mb-2 space-x-2`}>
                ...
                {/* Navbar */}
                <div className=" fixed  right-0 w-full  md:w-4/5 z-0  top-0 bg-white ">
                    <nav className="h-14  border-b-[1px] p-4 flex justify-between  items-center">
                        <div className="flex items-center ">
                            <RxHamburgerMenu onClick={panel} className="text-xl text-slate-500 md:hidden" />
