...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className="flex mt-[4rem] md:mt-[5rem] min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link href="/forgotpassword"><span className="font-semibold cursor-pointer leading-6 text-indigo-600 hover:text-indigo-500">Forgot Password?</span></Link>
                </div>
              </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?{' '}
            <Link href="/signup"><span className="font-semibold cursor-pointer leading-6 text-indigo-600 hover:text-indigo-500">Sign up here</span></Link>
          </p>
        </div>
      </div>
    </>
