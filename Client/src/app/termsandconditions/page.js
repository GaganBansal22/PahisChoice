...
function TermsAndConditions() {
    return (
        <div className='md:mt-32 mt-20 mx-5 md:mx-40'>
            <h1 className='md:text-3xl text-2xl font-bold text-center '>TERMS AND CONDITIONS</h1>

            <h1 className='md:text-2xl text-xl mt-5 md:mt-0 font-bold'>TERMS OF USE</h1>

            <p className='mt-5'>Last updated </p>

            <h1 className='mt-8 font-bold'>AGREEMENT TO OUR LEGAL TERMS
            </h1>
            <p className='mt-5'>&quot;We are Pahis Choice, operating jewellery, bags, shoes, clothes, and any other related products and services that refer or link to these legal terms (the &quot;Legal Terms&quot;) (collectively, the &quot;Services&quot;).
                You can contact us by email at pahischoice@gmail.com or by mail to Pahis Choice, Guwahati, Assam, 781024. These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&quot;you&quot;), and Pahis Choice, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.&quot;<br /><br />
                ...
                date such revised Legal Terms are posted.<br /><br /><br />
                We recommend that you print a copy of these Legal Terms for your records.</p>




            <h1 className='mt-8 text-xl font-bold'>TABLE OF CONTENTS
            </h1>



            <p className='mt-5 text-indigo-500'>
                <a href='#ourservices'>1. OUR SERVICES</a> <br />
                <a href='#intellectualproperty'>2. INTELLECTUAL PROPERTY RIGHTS</a> <br />
                <a href='#userrepresentations'>3. USER REPRESENTATIONS</a> <br />
                <a href='#prohibitedactivities'>4. PROHIBITED ACTIVITIES</a> <br />
                <a href='#usergeneratedcontributions'>5. USER GENERATED CONTRIBUTIONS</a> <br />
                <a href='#contributionlicense'>6. CONTRIBUTION LICENSE</a> <br />
                <a href='#servicesmanagement'>7. SERVICES MANAGEMENT</a> <br />
                <a href='#termandtermination'>8. TERM AND TERMINATION</a> <br />
                <a href='#modificationsandinterruptions'>9. MODIFICATIONS AND INTERRUPTIONS</a> <br />
                <a href='#governinglaw'>10. GOVERNING LAW</a> <br />
                <a href='#disputeresolution'>11. DISPUTE RESOLUTION</a> <br />
                <a href='#corrections'>12. CORRECTIONS</a> <br />
                <a href='#disclaimer'>13. DISCLAIMER</a> <br />
                <a href='#limitationsofliability'>14. LIMITATIONS OF LIABILITY</a> <br />
                <a href='#indemnification'>15. INDEMNIFICATION</a> <br />
                <a href='#userdata'>16. USER DATA</a> <br />
                <a href='#electroniccommunications'>17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a> <br />
                <a href='#miscellaneous'>18. MISCELLANEOUS</a> <br />
                <a href='#contactus' className='transition-all duration-200'>19. CONTACT US</a> <br />
            </p>
            ...
            <h1 id='ourservices' className='mt-8 text-xl font-bold'>1. OUR SERVICES</h1>
            <p className='mt-5'>The information provided when using the Services is not intended for distribution to
            ...
            <h1 id='intellectualproperty' className='mt-8 text-xl font-bold'>2. INTELLECTUAL PROPERTY RIGHTS</h1>
            <h1 className='mt-8 font-bold text-lg'>Our intellectual property</h1>


            <p className='mt-5'>We are the owner or the licensee of all intellectual property rights in our Services,
            ...
            <h1 className='mt-8 font-bold text-lg'>Your use of our Services
            </h1>
            <p className='mt-5'>
                ...
                in this section or elsewhere in our Legal Terms, please address your request to pahischoice@gmail.com. If we ever grant you the permission to post, reproduce, or publicly
            ...
            <h1 className='mt-8 font-bold text-lg'>Your submissions</h1>

            <p className='mt-5'>Please review this section and the &quot;PROHIBITED ACTIVITIES&quot; section carefully prior
                to using our Services to understand the (a) rights you give us and (b) obligations you
                have when you post or upload any content through the Services.<br /><br />
                <span className='font-bold text-gray-700'>Submissions:</span> By directly sending us any question, comment, suggestion, idea,
                ...
                through any part of the Services you:</p>


            <ul className='list-disc mt-5 md:ml-10'>
                <li>confirm that you have read and agree with our <a className='cursor-pointer text-indigo-600 ' href='#prohibitedactivities'>&quot;PROHIBITED ACTIVITIES&quot;</a>
                ...
                <li> to the extent permissible by applicable law, waive any and all moral rights to
                any such Submission;</li>
                <li>warrant that any such Submission are original to you or that you have the
            ...
            <p className='mt-5'>You are solely responsible for your Submissions and you expressly agree to
            ...
            <h1 id='userrepresentations' className='mt-8 text-xl font-bold'>3. USER REPRESENTATIONS
            </h1>

            <p className='mt-5'>By using the Services, you represent and warrant that: (1) you have the legal
                ...
                the Services will not violate any applicable law or regulation.<br /><br />
                If you provide any information that is untrue, inaccurate, not current, or incomplete,
                we have the right to suspend or terminate your account and refuse any and all
                current or future use of the Services (or any portion thereof).</p>



            <h1 id='prohibitedactivities' className='mt-8 text-xl font-bold'>4. PROHIBITED ACTIVITIES</h1>

            <p className='mt-5'>You may not access or use the Services for any purpose other than that for which we
            ...
            <ul className='list-disc mt-5 ml-10'>
                ...
                <li>Copy or adapt the Services&apos; software, including but not limited to Flash, PHP,
                ...
                software.</li>
                <li>Use a buying agent or purchasing agent to make purchases on the Services.<br />
                ...
                <li>Use the Services as part of any effort to compete with us or otherwise use the
                Services and/or the Content for any revenue-generating endeavor or
                commercial enterprise.</li>
            ...
            <h1 id='usergeneratedcontributions' className='mt-8 text-xl font-bold'>5. USER GENERATED CONTRIBUTIONS</h1>


            <p className='mt-5'>The Services does not offer users to submit or post content. We may provide you
            ...
            <h1 id='contributionlicense' className='mt-8 text-xl font-bold'>6. CONTRIBUTION LICENSE
            </h1>

            <p className='mt-5'>You and Services agree that we may access, store, process, and use any information
                ...
                we can use and share such feedback for any purpose without compensation to you.<br /><br />
            ...
            <h1 id='servicesmanagement' className='mt-8 text-xl font-bold'>7. SERVICES MANAGEMENT
            </h1>

            <p className='mt-5'>We reserve the right, but not the obligation, to: (1) monitor the Services for violations
                ...
                functioning of the Services</p>


            <h1 id='termandtermination' className='mt-8 text-xl font-bold'>8. TERM AND TERMINATION</h1>

            <p className='mt-5'>These Legal Terms shall remain in full force and effect while you use the Services.
            ...
            <h1 id='modificationsandinterruptions' className='mt-8 text-xl font-bold'>9. MODIFICATIONS AND INTERRUPTIONS</h1>

            <p className='mt-5'>We reserve the right to change, modify, or remove the contents of the Services at any
            ...
            <h1 id='governinglaw' className='mt-8 text-xl font-bold'>10. GOVERNING LAW</h1>

            <p className='mt-5'>These Legal Terms shall be governed by and defined following the laws of
                __________. __________ and yourself irrevocably consent that the courts of
                __________ shall have exclusive jurisdiction to resolve any dispute which may arise
                in connection with these Legal Terms.</p>

            <h1 id='disputeresolution' className='mt-8 text-xl font-bold'>11. DISPUTE RESOLUTION</h1>
            <h1 className='mt-8 text-lg font-bold'>Informal Negotiations
            </h1>

            <p className='mt-5'>To expedite resolution and control the cost of any dispute, controversy, or claim
                related to these Legal Terms (each a &quot;Dispute&quot; and collectively, the &quot;Disputes&quot;)
                brought by either you or us (individually, a &quot;Party&quot; and collectively, the &quot;Parties&quot;), the Parties agree to first attempt to negotiate any Dispute (except those Disputes
            ...
            <h1 className='mt-8 text-lg font-bold'>Binding Arbitration</h1>

            <p className='mt-5'>Any dispute arising out of or in connection with these Legal Terms, including any
            ...
            <h1 className='mt-8 text-lg font-bold'>Restrictions</h1>

            <p className='mt-5'>The Parties agree that any arbitration shall be limited to the Dispute between the
            ...
            <h1 className='mt-8 text-lg font-bold'>Exceptions to Informal Negotiations and Arbitration
            </h1>


            <p className='mt-5'>The Parties agree that the following Disputes are not subject to the above provisions
            ...
            <h1 id='corrections' className='mt-8 text-xl font-bold'>12. CORRECTIONS</h1>

            <p className='mt-5'>There may be information on the Services that contains typographical errors,
            ...
            <h1 id='disclaimer' className='mt-8 text-xl font-bold'>13. DISCLAIMER</h1>

            <p className='mt-5'>THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU
                ...
                OR THROUGH THE SERVICES BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR
            ...
            <h1 className='mt-8 text-xl font-bold'>14. LIMITATIONS OF LIABILITY</h1>

            <p className='mt-5'>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE
            ...
            <h1 id='indemnification' className='mt-8 text-xl font-bold'>15. INDEMNIFICATION</h1>

            <p className='mt-5'>You agree to defend, indemnify, and hold us harmless, including our subsidiaries,
            ...
            <h1 id='userdata' className='mt-8 text-xl font-bold'>16. USER DATA</h1>

            <p className='mt-5'>We will maintain certain data that you transmit to the Services for the purpose of
            ...
            <h1 id='electroniccommunications' className='mt-8 text-xl font-bold'>17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS,
                AND SIGNATURES
            </h1>

            <p className='mt-5'>Visiting the Services, sending us emails, and completing online forms constitute
                ...
                USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND
            ...
            <h1 id='miscellaneous' className='mt-8  text-xl font-bold'>18. MISCELLANEOUS</h1>

            <p className='mt-5'>These Legal Terms and any policies or operating rules posted by us on the Services
                ...
                Terms and the lack of signing by the parties hereto to execute these Legal Terms.</p>


            <h1 id='contactus' className='mt-8 text-xl font-bold '>19. CONTACT US
            </h1>
            <p className='mt-5'>In order to resolve a complaint regarding the Services or to receive further
